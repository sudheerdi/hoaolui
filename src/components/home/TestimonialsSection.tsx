  ...
  const testimonials = [
    {
      ...
      quote:
        "CommUnity Connect transformed how we manage our 200-home community. Payment collection is now automated, and residents love the transparency.",
      rating: 5,
    },
    {
      name: "Michael Chen",
    ...
    },
    {
      ...
      image:
        "https://readdy.ai/api/search-image?query=Professional%20Hispanic%20woman%20with%20warm%20smile%2C%20business%20headshot%20portrait%2C%20clean%20background%2C%20professional%20lighting%2C%20friendly%20and%20approachable%20expression%2C%20professional%20attire%2C%20high%20quality%20corporate%20photography%2C%20confident%20appearance&width=150&height=150&seq=testimonial-3&orientation=squarish",
      quote:
        "Finally, an HOA platform that actually works! I can pay dues, submit requests, and stay informed about community events all in one place.",
      rating: 5,
    },
  ];
            ...
            <Card key={index} className="text-center">
              ...
              <div className="flex justify-center mb-4">
                {[...Array(testimonial.rating)].map((_, i) => (
                  <div
                    key={i}
                    className="w-5 h-5 flex items-center justify-center text-yellow-400"
                  >
