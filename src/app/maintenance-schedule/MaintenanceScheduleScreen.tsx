...
export default function MaintenanceScheduleScreen() {
  ...
  const handleVendorFieldChange = (
    field: keyof ServiceRecord["vendorDetails"],
    value: string
  ) => {
    setScheduledServices((prev) =>
      prev.map((service) =>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead style={{ backgroundColor: "#DCDCDC" }}>
                    <tr>
                      <th
                        className="px-6 py-3 text-left text-sm font-medium uppercase tracking-wider border-r border-gray-200"
                        style={{ color: "#000000" }}
                      >
                        <input
                          type="checkbox"
                          ...
                          checked={
                            selectedRows.length === scheduledServices.length &&
                        ...
                        <td colSpan={8} className="px-6 py-12 text-center">
                          <div className="border-2 border-dashed border-gray-300 rounded-lg p-8">
                            <p className="text-gray-500">
                              Click Add button from sample records below or
                        ...
                        <tr key={service.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-base text-black font-medium border-r border-gray-200">
                            {service.isEditing ? (
                              ...
                              formatDateForDisplay(service.schedule) ||
                              service.schedule
                            )}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-base text-black font-medium border-r border-gray-200">
                          ...
                          <td className="px-6 py-4 text-base text-black font-medium">
                            {service.isEditing ? (
                              <button
                                onClick={() =>
                                  handleVendorDetailsClick(service.id)
                                }
            ...
            <div className="px-6 py-4 space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleVendorFieldChange("businessName", e.target.value)
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleVendorFieldChange("firstName", e.target.value)
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleVendorFieldChange("lastName", e.target.value)
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleVendorFieldChange("email", e.target.value)
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleVendorFieldChange("phoneNumber", e.target.value)
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
