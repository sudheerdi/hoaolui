      ...
      <table className="w-full">
        <thead className="bg-[#DCDCDC]">
          <tr>
            ...
            <th className="px-6 py-3 text-left text-sm font-semibold text-black">Issued</th>
          </tr>
        </thead>
        <tbody className="divide-y divide-gray-200">
          {violations.map((violation) => (
            ...
            >
              <td className="px-6 py-4 text-sm text-black font-medium">{violation.type}</td>
              <td className="px-6 py-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-black font-medium whitespace-nowrap">{violation.progress}%</span>
                </div>
              </td>
              <td className="px-6 py-4">
                {isResolved ? (
              ...
              <td className="px-6 py-4 text-sm text-black font-medium">{violation.issued}</td>
            </tr>
          ))}
        </tbody>
      </table>
