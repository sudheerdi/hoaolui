...
export default function ApprovalRequestsScreen() {
  ...
  const mockRequests: ApprovalRequest[] = [
    ...
    },
    {
      ...
      fullDescription: 'The community pool heating system has not been working for the past week. Water temperature is too cold for comfortable swimming. Multiple residents have complained. Need professional assessment and repair of the heating unit.',
      status: 'approved',
      date: '2024-01-09',
      icon: 'ri-tools-line',
      priority: 'medium',
    ...
    },
    {
      ...
      fullDescription: 'Requesting installation of additional security cameras in the parking garage due to recent vandalism incidents. Proposed locations include entrance/exit points and blind spots identified by security assessment.',
      status: 'pending',
      date: '2024-01-08',
      icon: 'ri-camera-line',
      priority: 'high',
    ...
    },
    {
      ...
      fullDescription: 'Proposal to renovate the central garden area with new plants, improved irrigation system, and walking paths. Includes detailed landscaping plan and cost estimates. Will enhance property value and resident enjoyment.',
      status: 'rejected',
      date: '2024-01-07',
      icon: 'ri-plant-line',
      priority: 'low',
    ...
    },
    {
      ...
      fullDescription: 'Requesting modification to current pet policy to allow larger dog breeds. Current policy restricts dogs over 50 pounds. Proposing increase to 75 pounds with additional requirements for training certification and insurance.',
      status: 'pending',
      date: '2024-01-06',
  ...
  const openCount = mockRequests.filter(req => req.status === 'pending').length;
  const closedCount = mockRequests.filter(req => req.status === 'approved' || req.status === 'rejected').length;
    ...
    <div className="min-h-screen bg-[#1E293B] p-[10px]">
      ...
      <div className="lg:ml-[260px] bg-white rounded-lg min-h-[calc(100vh-20px)] flex flex-col">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-6">
              <div className="flex items-center space-x-1">
                ...
                <span className="text-sm font-bold text-black">Open : {openCount}</span>
              </div>
              <div className="flex items-center space-x-1">
                <i className="ri-check-line text-green-600"></i>
                <span className="text-sm font-bold text-black">Closed : {closedCount}</span>
              </div>
            </div>
        ...
        <div className="flex flex-1 overflow-hidden bg-[#F9FAFB]">
          <div className={`flex-1 transition-all duration-300 ${selectedRequest ? 'mr-[384px]' : ''}`}>
            <div className="p-4 h-[calc(100vh-80px)] overflow-y-auto">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-4">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="mb-4">
                      <p className="text-lg font-medium text-black mb-1">Hello Approver,</p>
                      <p className="text-base font-medium text-black">
                        <span className="font-bold">Home owner</span> has submitted an approval request, please review and take action.
                      </p>
                    </div>
